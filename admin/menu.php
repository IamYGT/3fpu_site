     ...
     <div class="deznav">
       <div class="deznav-scroll">
         <ul class="metismenu" id="menu">
		   ...
		   <li>
             <a class="ai-icon" href="dosya-yukle" aria-expanded="false">
               <i class="fas fa-disease"></i>
               <span class="nav-text">Dosya Yükleme</span>
             </a>
           </li>
           ...
           <li>
             <a class="ai-icon" href="galeriler?do=files&id=16" aria-expanded="false">
               <i class="fas fa-disease"></i>
               <span class="nav-text">Projeler</span>
             </a>
           </li>
		       <li>
             <a class="ai-icon" href="kategoriler" aria-expanded="false">
               <i class="fas fa-disease"></i>
               <span class="nav-text">Kategoriler</span>
             </a>
           </li>
		       <li>
             <a class="ai-icon" href="projeler" aria-expanded="false">
               <i class="fas fa-disease"></i>
           ...
           <li>
             <a class="ai-icon" href="galeriler" aria-expanded="false">
               <i class="fas fa-images"></i>
               <span class="nav-text">Galeriler</span>
             </a>
           </li>
           ...
           <li>
             <a class="ai-icon" href="yoneticiler" aria-expanded="false">
