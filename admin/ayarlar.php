                            ...
                            <div class="card-body">
                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#kurumsal"><i class="la la-user mr-2"></i> Kurumsal</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="#sayilar"><i class="la la-user mr-2"></i> Sayılarla Biz</a>
                                        </li>
										...
										<div class="tab-content">
															...
															<div class="form-validation">
																<div class="row">
																	...
																	<div class="col-xl-12 mb-3">
																		...
																		<div class="form-group row">
																			<label class="col-lg-2 col-form-label" for="val-suggestions">Katalog Linki<span class="text-danger">*</span>  </label>
																			<div class="col-lg-10">
 																			  <input type="text" name="iStatusCars" class="form-control" placeholder="Link Giriniz"  value="<?php echo $row_info["iStatusCars"]?>">
											...
											?>
																	<div class="col-xl-12 col-lg-12 mb-3">
																	 ...
																	 <div class="form-group row">
																			<label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Hakkımızda</label>
																			<textarea class="form-control ckeditor col-6"  name="egitim_<?php echo $LANGUAGE_CODE; ?>"> <?php echo $row_info["egitim_".$LANGUAGE_CODE]?></textarea>
										 ...
										 ?>
																 <div class="col-xl-12 col-lg-12 mb-3">
																	...
																	<div class="form-group row">
																		 <label class="text-label"><i class="flag-icon flag-icon-<?php echo $LANGUAGE_CODE; ?> icon-2x"></i>Kısa Hakkımızda</label>
																		 <textarea class="form-control ckeditor col-6"  name="deneyim_<?php echo $LANGUAGE_CODE; ?>"> <?php echo $row_info["deneyim_".$LANGUAGE_CODE]?></textarea>
													...
													<div class="card">
														<div class="card-body">
															<div class="row">
																<div class="col-xl-12 col-lg-12 mb-3">
																	<div class="form-group row">
																		<label class="col-lg-4 col-form-label" for="">Farklı Tasarım <span class="text-danger">*</span> </label>
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">

																				<input type="text" name="dosyasayisi" class="form-control" placeholder="Ürün Çeşidi" value="<?php echo $row_info["dosyasayisi"]?>">
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="form-group row">
																		...
																		<div class="col-lg-8">
																			<div class="input-group mb-3 input-primary-o">
																				...
																				<input type="text" name="strMailHost" class="form-control" placeholder="Bölge Sayısı"  value="<?php echo $row_info["strMailHost"]?>">
																			</div>
																		</div>
																	</div>
																</div>
